...
Query = function () {
  function Query(endpoint, options) {(0, _classCallCheck3.default)(this, Query);
    ...
    this._options.itemFilter = (0, _lodash.isEmpty)(this._options.itemFilter) ? [] : (0, _lodash.castArray)(this._options.itemFilter);
  }(0, _createClass3.default)(Query, [{ key: 'setPage', value: function setPage(
    ...
    page) {
      ...
      return this;
    } }, { key: 'setEntriesPerPage', value: function setEntriesPerPage(
    ...
    name) {
      return (0, _lodash.find)(this._options.itemFilter, { name: name });
    } }, { key: 'setEndTimeTo', value: function setEndTimeTo(

    time) {
      this.setFilter('EndTimeTo', time.toISOString ? time.toISOString() : time);

      return this;
    } }, { key: 'setEndTimeFrom', value: function setEndTimeFrom(
...

    {
      ...
      return (0, _requestPromise2.default)(this._endpoint + '?' + queryString, { json: true });
    } }]);return Query;}();exports.default =
